...
function identifyIntent(question = "") {
  ...
  if (byRegex(text, /nexora runtime|runtime do nexora|o que e o runtime/)) return { intent: "nexora_runtime", type: "query", module: "NEXORA OS", action: null, requiresConfirmation: false, critical: false };
